    ...
    >
      <div className="relative z-10 mx-auto flex w-full max-w-[1200px] flex-1 flex-col">
        ...
        <div className="relative z-10 flex flex-1 items-center">
          ...
          <div
            aria-hidden
            className="text-amber pointer-events-none absolute end-[-40px] top-1/2 hidden h-[420px] w-[420px] -translate-y-1/2 lg:block xl:end-[-60px] xl:h-[520px] xl:w-[520px] 2xl:end-[-80px] 2xl:h-[640px] 2xl:w-[640px]"
          >
            <Hero3DLazy />
          </div>
        </div>
