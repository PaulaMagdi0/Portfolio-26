...
const SOCIAL_PATHS: Record<string, string> = {
  ...
  'home.contact.socials.hackerrank':
    'M4 4h16v16H4zM8 7v10M16 7v10M8 12h8',
};
                ...
                return (
                  <li key={s.url}>
                    ...
                    >
                      ...
                      <span
                        aria-hidden
                        className="ml-auto inline-flex transition-transform group-hover:-translate-y-0.5 group-hover:translate-x-0.5"
                      >
                        <svg
